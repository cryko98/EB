...
const CreatePost: React.FC = () => {
  return (
    <div className="bg-fb-card rounded-lg p-4 shadow-md">
      <div className="flex items-center space-x-3 pb-3 border-b border-fb-hover">
        <img src="https://epstagram.xyz/images/pfp/jeffrey-epstein.png" alt="User Avatar" className="w-10 h-10 rounded-full" />
        <div className="flex-1 bg-fb-input rounded-full text-fb-secondary-text px-4 py-2 cursor-pointer hover:bg-gray-600">
          What's on your mind?
        </div>
      </div>
      <div className="flex justify-around pt-3">
        <div className="flex items-center space-x-2 p-2 rounded-lg hover:bg-fb-hover cursor-pointer">
