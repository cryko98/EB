...
const SidebarLink: React.FC<SidebarLinkProps> = ({ icon, text }) => {
  return (
    <a href="#" className="flex items-center space-x-3 p-2 rounded-lg hover:bg-fb-hover">
