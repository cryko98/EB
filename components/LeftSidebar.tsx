...
const LeftSidebar: React.FC<{ onShowEvents: () => void; onShowInnerCircle: () => void; onShowFlightLogs: () => void; }> = ({ onShowEvents, onShowInnerCircle, onShowFlightLogs }) => {
